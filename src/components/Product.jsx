  ...
  return <div>
    ...
    overflow-hidden group transition'>
      <div className='w-full h-full flex justify-center items-center'>
        ...
        <div className='absolute top-0 right-0 group-hover:right-2 duration-300 p-2 flex 
        flex-col justify-center items-center gap-y-2 opacity-0 group-hover:opacity-100 transition-all'>
          <button onClick={()=>addToCart(product,id)}>
            <div className='flex justify-center items-center text-white w-12 h-12 bg-slate-600'>
